                        ...
                        <div class="col-sm-3">
                            <div class="card mb-3">
                                <div class="view overlay">
                                    <img class="card-img-top gambar" src="{{ $product->image }}" alt="Card image cap" style="height: 250px">
                                    <a href="#!">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text text-center">Giá: {{ number_format($product->price,2,',','.') }} VND
                                    </p>
